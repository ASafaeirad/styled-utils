...
test('it should return different thickness for top and bottom and same for left and right if only 3 args peresent', () => {
  const t = ThicknessHelper('px')(0, 2, 3);
